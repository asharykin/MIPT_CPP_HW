...
template<typename U, typename D> struct Has { };

template<typename U, typename T, typename... Ts> struct Has<U, Deque<T, Ts...>>
{
    constexpr static auto value = std::is_same_v<U, T> || Has<U, Deque<Ts...>>::value;
};

template<typename U> struct Has<U, Deque<>>
{
    constexpr static auto value = false;
};

template<typename U, typename D> constexpr auto has_v = Has<U, D>::value;
