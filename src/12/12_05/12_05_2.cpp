...
namespace parser
{
    ...
    boost::spirit::x3::rule < struct rule_3_tag, List    > rule_3;

    boost::spirit::x3::rule < struct rule_4_tag, Operand > rule_4;

    boost::spirit::x3::rule < struct rule_5_tag, Factorial > rule_5;

    boost::spirit::x3::rule < struct rule_6_tag, Operand > rule_6;
    ...
    auto rule_3_def = rule_4 >> *
    (
        boost::spirit::x3::char_('^') >> rule_4
    );
    ...
    auto rule_5_def = rule_6 >> boost::spirit::x3::omit[boost::spirit::x3::char_('!')];
...
//  ------------------------------------------------------------
    ...
    auto operator()(Factorial const & fact) const -> double
    {
        auto x = boost::apply_visitor(*this, fact.operand);
...
//  --------------------------------------------------------------
    ...
    std::cout << std::format("main : enter std::string string(s) : \n");
